const { validateIsProvided, validateIsCorrectType, validateIsPositive, validateIsInRange, validateIsInteger } = require("../../default-validators");
...
module.exports = validateDiscountPercentage